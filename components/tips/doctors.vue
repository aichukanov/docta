...
<i18n lang="json">
{
	...
	"sr": {
		...
		"TipBarCity": "Bar ima Bolnicu sa odjeljenjima za odrasle i djecu i Dom Zdravlja (poliklinika).",
		...
		"TipClinicalCenter3": "(261 ljekar!).",
		"And": "i",
		"TipPediatricBudva": "Budva ima Dom Zdravlja sa dječjim odjeljenjem, ali nema državnu bolnicu. U slučaju noćne hitne situacije sa djetetom, bolje je odmah ići u bolnicu u Kotoru ili Baru.",
		"TipSurgeryBudva": "Budva ima Dom Zdravlja (polikliniku), ali nema državnu bolnicu. Dostupna je samo ambulantna njega. Najbliža operaciona sala je u bolnici u Kotoru.",
		"TipPediatricTivat": "Tivat nema državnu bolnicu. U slučaju noćne hitne situacije sa djetetom, bolje je odmah ići u bolnice u Kotoru ili Risnu.",
		"TipSurgeryTivat": "Tivat ima Dom Zdravlja (polikliniku), ali nema državnu bolnicu. Dostupna je samo ambulantna njega. Najbliže operacione sale su u bolnicama u Kotoru i Risnu.",
		"TipPediatricUlcinj": "Ulcinj nema državnu bolnicu. U slučaju noćne hitne situacije sa djetetom, bolje je odmah ići u bolnicu u Baru, koja ima dječje odjeljenje.",
		"TipSurgeryUlcinj": "Ulcinj ima Dom Zdravlja (polikliniku), ali nema državnu bolnicu. Dostupna je samo ambulantna njega. Najbliža operaciona sala je u bolnici u Baru.",
		"TipHercegNovi": "Herceg Novi nema svoju bolnicu. Najbliže su u",
		"TipPediatricHercegNovi": "Herceg Novi nema državnu bolnicu. U slučaju noćne hitne situacije sa djetetom, bolje je odmah ići u bolnice u Kotoru ili Risnu.",
		"TipSurgeryHercegNovi": "Herceg Novi ima Dom Zdravlja (polikliniku), ali nema državnu bolnicu. Dostupna je samo ambulantna njega. Najbliže operacione sale su u bolnicama u Kotoru i Risnu."
	},
	"sr-cyrl": {
		...
		"TipBarCity": "Бар има Болницу са одјељењима за одрасле и дјецу и Дом Здравља (поликлиника).",
		...
		"TipClinicalCenter3": "(261 љекар!).",
		"And": "и",
		"TipPediatricBudva": "Будва има Дом Здравља са дјечјим одјељењем, али нема државну болницу. У случају ноћне хитне ситуације са дјететом, боље је одмах ићи у болницу у Котору или Бару.",
		"TipSurgeryBudva": "Будва има Дом Здравља (поликлинику), али нема државну болницу. Доступна је само амбулантна њега. Најближа операциона сала је у болници у Котору.",
		"TipPediatricTivat": "Тиват нема државну болницу. У случају ноћне хитне ситуације са дјететом, боље је одмах ићи у болнице у Котору или Рисну.",
		"TipSurgeryTivat": "Тиват има Дом Здравља (поликлинику), али нема државну болницу. Доступна је само амбулантна њега. Најближе операционе сале су у болницама у Котору и Рисну.",
		"TipPediatricUlcinj": "Улцињ нема државну болницу. У случају ноћне хитне ситуације са дјететом, боље је одмах ићи у болницу у Бару, која има дјечје одјељење.",
		"TipSurgeryUlcinj": "Улцињ има Дом Здравља (поликлинику), али нема државну болницу. Доступна је само амбулантна њега. Најближа операциона сала је у болници у Бару.",
		"TipHercegNovi": "Херцег Нови нема своју болницу. Најближе су у",
		"TipPediatricHercegNovi": "Херцег Нови нема државну болницу. У случају ноћне хитне ситуације са дјететом, боље је одмах ићи у болнице у Котору или Рисну.",
		"TipSurgeryHercegNovi": "Херцег Нови има Дом Здравља (поликлинику), али нема државну болницу. Доступна је само амбулантна њега. Најближе операционе сале су у болницама у Котору и Рисну."
	},
	"de": {
