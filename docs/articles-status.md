...
> Что осталось: (1) обложка `public/img/articles/allergy-medicines-in-montenegro.webp` — flat-плейсхолдер (PIL, горы/море/пыльца), нужна настоящая иллюстрация в общем стиле; (2) вычитка носителями sr / sr-cyrl / de / tr; (3) на прод не выкатана.
