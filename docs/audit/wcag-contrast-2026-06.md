...
> **Имена токенов в этом документе устарели.** В августе 2026 дизайн-система
> переехала в пакет `@ach/ui-kit`, и все токены получили префикс: `--color-rating`
> теперь `--kit-color-rating` и так далее. Текст аудита оставлен как есть —
> это датированная запись о состоянии на июнь 2026, а не действующая справка.
