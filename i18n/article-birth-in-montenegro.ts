...
export default {
	messages: {
		'en': {
			...
			BimCosts3Link: 'catalog of medical services',
			BimCosts3End:
		...
		'ru': {
			...
			BimCosts3Link: 'каталоге медицинских услуг',
			BimCosts3End:
		...
		'sr': {
			...
			BimCosts3Link: 'katalogu medicinskih usluga',
			BimCosts3End:
		...
		'sr-cyrl': {
			...
			BimCosts3Link: 'каталогу медицинских услуга',
			BimCosts3End:
		...
		'de': {
			...
			BimCosts3Link: 'Katalog medizinischer Leistungen',
			BimCosts3End:
		...
		'tr': {
			...
			BimCosts3Link: 'tıbbi hizmetler kataloğumuzda',
			BimCosts3End:
