	...
	messages: {
		'en': {
			...
			CityHcPharmacy2_budva:
				'Chat members mention a 24-hour pharmacy near the bus station. Duty schedules change, so check locally; at night, in an acute situation, it is more reliable to go straight to hitna pomoć.',
			...
			CityHcPharmacy1_podgorica:
				'Podgorica has hundreds of pharmacies: the state Montefarm chain and private networks. There are 24-hour duty pharmacies.',
		...
		'ru': {
			...
			CityHcPharmacy2_budva:
				'Участники чатов упоминают круглосуточную аптеку у автовокзала. График дежурных аптек меняется — уточняйте на месте; ночью при острой ситуации надёжнее обращаться сразу в hitna pomoć.',
			...
			CityHcPharmacy1_podgorica:
				'Аптек в Подгорице сотни: государственная сеть Montefarm и частные сети. Есть круглосуточные дежурные аптеки.',
			CityHcPharmacy2_podgorica:
		...
		'sr': {
			...
			CityHcPharmacy2_budva:
				'Učesnici četova pominju noćnu apoteku kod autobuske stanice. Raspored dežurstava se mijenja, provjerite na licu mjesta; noću je u hitnim situacijama pouzdanije otići pravo u hitnu pomoć.',
			...
			CityHcPharmacy1_podgorica:
				'U Podgorici postoje stotine apoteka: državni lanac Montefarm i privatni lanci. Postoje i non-stop dežurne apoteke.',
			CityHcPharmacy2_podgorica:
		...
		'sr-cyrl': {
			...
			CityHcPharmacy2_budva:
				'Учесници четова помињу ноћну апотеку код аутобуске станице. Распоред дежурстава се мијења, провјерите на лицу мјеста; ноћу је у хитним ситуацијама поузданије отићи право у хитну помоћ.',
			...
			CityHcPharmacy1_podgorica:
				'У Подгорици постоје стотине апотека: државни ланац Montefarm и приватни ланци. Постоје и нон-стоп дежурне апотеке.',
			CityHcPharmacy2_podgorica:
		...
		'de': {
			...
			CityHcPharmacy2_budva:
				'Chat-Teilnehmer erwähnen eine 24-Stunden-Apotheke am Busbahnhof. Die Notdienstpläne ändern sich, fragen Sie vor Ort nach; nachts ist es im Akutfall zuverlässiger, direkt zur hitna pomoć zu fahren.',
			...
			CityHcPharmacy1_podgorica:
				'In Podgorica gibt es Hunderte Apotheken: die staatliche Kette Montefarm und private Ketten. Es gibt Apotheken mit 24-Stunden-Notdienst.',
			CityHcPharmacy2_podgorica:
		...
		'tr': {
			...
			CityHcPharmacy2_budva:
				"Sohbet üyeleri otogar yakınında gece gündüz açık bir eczaneden söz ediyor. Nöbet programları değişir, yerinde teyit edin; gece acil durumda doğrudan hitna pomoć'a gitmek daha güvenilirdir.",
			...
			CityHcPharmacy1_podgorica:
				"Podgorica'da yüzlerce eczane vardır: devlet zinciri Montefarm ve özel zincirler. Gece gündüz açık nöbetçi eczaneler de mevcuttur.",
			CityHcPharmacy2_podgorica:
