...
export default {
	messages: {
		'en': {
			...
			HcsForeigners3:
				'The UK and Poland work on reciprocity: a valid GHIC/EHIC or even just proof of insurance plus a passport is enough for urgent care. Swiss, Swedish, Danish and Norwegian insured pay on the spot and claim reimbursement at home. In all cases only urgent/necessary care is covered — planned treatment and services over €150 require prior approval of your home insurer.',
			HcsForeigners4:
		...
		'sr-cyrl': {
			...
			HcsForeigners3:
				'Велика Британија и Пољска функционишу по принципу реципроцитета: за хитну помоћ довољни су пасош и важећи GHIC/EHIC или други доказ осигурања. Осигураници из Швајцарске, Шведске, Данске и Норвешке плаћају на лицу мјеста и траже рефундацију код куће. У свим случајевима покривена је само хитна/неопходна заштита — планирано лијечење и услуге скупље од 150 € захтијевају претходну сагласност матичног осигуравача.',
			HcsForeigners4:
