...
export default {
	messages: {
		'en': {
			...
			HcsState1b: ', pulmonology in Brezovik, psychiatry in ',
		...
		'ru': {
			...
			HcsState1b: ', пульмонология в Брезовике, психиатрия в ',
		...
		'sr': {
			...
			HcsState1b: ', plućne bolesti u Brezoviku, psihijatrija u ',
		...
		'sr-cyrl': {
			...
			HcsState1b: ', плућне болести у Брезовику, психијатрија у ',
		...
		'de': {
			...
			HcsState1RisanLink: 'Risan',
			HcsState1b: ', Lungenheilkunde in Brezovik, Psychiatrie in ',
			HcsState1DobrotaLink: 'Dobrota',
			HcsState1c: '):',
			HcsStateLevel1:
		...
		'tr': {
			...
			HcsState1b: ' ortopedi, Brezovik’te göğüs hastalıkları, ',
			...
			HcsStateLevel2d: ',',
			HcsStateLevel2CetinjeLink: 'Cetinje',
			HcsStateLevel2e: ' ve Pljevlja’daki genel hastaneler;',
