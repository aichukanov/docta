...
export default {
	messages: {
		...
		'ru': {
			...
			'HcsEmergency3a':
				'При серьёзных состояниях основной адрес — Urgentni centar',
		...
		'tr': {
			...
			'HcsEmergency3b':
				" 7/24 açık Urgentni centar'ıdır. Sahil şehirlerinde akut vakalar",
			'HcsEmergency3KotorLink': 'Kotor',
			'HcsEmergency3c': ' veya',
			'HcsEmergency3BarLink': 'Bar',
			'HcsEmergency3d':
			...
			'HcsEmergency3e':
				" gidilir, ya da yerel dom zdravlja'daki hitna pomoć'a başvurulur.",
			'HcsEmergency4':
