...
// Факты сверены с законом об обязательном медстраховании («Službeni list CG» 145/21, 048/24),
...
export default {
	messages: {
		'en': {
			...
			HcsEmergency3a:
				'For serious conditions the main destination is the Urgentni centar of the',
			HcsEmergency3KccgLink: 'Clinical Center of Montenegro (KCCG)',
			HcsEmergency3b:
				' in Podgorica, open 24/7. On the coast, acute cases go to the emergency rooms of the general hospitals in',
			HcsEmergency3KotorLink: 'Kotor',
			HcsEmergency3c: ' or',
			HcsEmergency3BarLink: 'Bar',
			HcsEmergency3d:
				'; for fractures and trauma near the Bay of Kotor, people often go straight to the',
			HcsEmergency3RisanLink: 'orthopedic hospital in Risan',
			HcsEmergency3e:
				". Otherwise there's the hitna pomoć unit at the local dom zdravlja.",
			HcsEmergency4:
			...
			HcsState1a:
				'Public healthcare has three tiers, plus specialized hospitals (orthopedics in ',
			HcsState1RisanLink: 'Risan',
			HcsState1b: ', pulmonology in ',
			HcsState1BrezovikLink: 'Brezovik',
			HcsState1b2: ', psychiatry in ',
			HcsState1DobrotaLink: 'Dobrota',
			HcsState1c: '):',
			HcsStateLevel1:
			...
			HcsStateLevel2a: 'Opšta bolnica — general hospitals in',
			HcsStateLevel2BarLink: 'Bar',
			HcsStateLevel2b: ',',
			HcsStateLevel2KotorLink: 'Kotor',
			HcsStateLevel2c: ', ',
			HcsStateLevel2NiksicLink: 'Nikšić',
			HcsStateLevel2c2: ', ',
			HcsStateLevel2BeraneLink: 'Berane',
			HcsStateLevel2c3: ',',
			HcsStateLevel2BijeloPoljeLink: 'Bijelo Polje',
			HcsStateLevel2d: ',',
			HcsStateLevel2CetinjeLink: 'Cetinje',
			HcsStateLevel2e: ' and ',
			HcsStateLevel2PljevljaLink: 'Pljevlja',
			HcsStateLevel2e2: ';',
			HcsStateLevel3Pre: '',
			HcsStateLevel3KccgLink: 'Klinički centar Crne Gore (KCCG)',
			HcsStateLevel3a:
				' in Podgorica — the country’s main multi-specialty hospital, where complex cases are referred.',
			HcsState2:
			...
			HcsKnjizica1SlListLink: '“Službeni list CG” 145/21',
			HcsKnjizica1b: ').',
			HcsKnjizica2:
			...
			HcsKnjizica3:
				'An important practical catch that in effect blocks most foreigners from getting a knjižica at all: you cannot be insured in two countries at once, so on first registration the Fund requires proof that you have deregistered from health insurance in your home country — and very few countries actually issue such a certificate. On top of that, the law simply has no category for foreigners whose residence permit is based on property ownership, company ownership without employment, or the digital nomad permit, and the old option of voluntarily buying into state insurance was not carried over into the current law.',
			HcsKnjizica4:
			...
			HcsWithout2:
				'Private clinics and practices are the everyday choice of most uninsured expats: a GP or specialist consultation costs €30–50, a comprehensive visit with ultrasound and lab tests around €80. Only a few private clinics have inpatient and surgical capacity — in an acute surgical emergency a private clinic will most likely redirect you to a state hospital.',
			HcsWithout3:
			...
			HcsForeigners4:
				'Russia, Ukraine, Kazakhstan and most other countries have no healthcare agreement with Montenegro. Citizens of these countries rely on paid medicine or private insurance.',

			HcsInsurance1a:
				'Private (voluntary) health insurance is offered by local insurers —',
			HcsInsurance1SavaLink: 'Sava',
			HcsInsurance1b: ',',
			HcsInsurance1LovcenLink: 'Lovćen',
			HcsInsurance1c: ',',
			HcsInsurance1UniqaLink: 'Uniqa',
			HcsInsurance1d: ',',
			HcsInsurance1GeneraliLink: 'Generali',
			HcsInsurance1e: ',',
			HcsInsurance1GraweLink: 'Grawe',
			HcsInsurance1f:
				'. Outpatient packages start around €18 per month for people under 40; a typical “foreigner” policy costs about €300 per year with a coverage limit around €10,000. Standard exclusions apply: pre-existing and chronic conditions are not covered, and there are waiting periods (usually 2 months, 9 for childbirth). A policy is also a mandatory document for residence-permit applications.',
			HcsInsurance2:
		...
		'ru': {
			...
			HcsEmergency3a: 'При серьёзных состояниях основной адрес — Urgentni centar',
			HcsEmergency3KccgLink: 'Клинического центра Черногории (KCCG)',
			HcsEmergency3b:
				' в Подгорице, он работает круглосуточно. На побережье с острыми случаями едут в приёмные отделения общих больниц в',
			HcsEmergency3KotorLink: 'Которе',
			HcsEmergency3c: ' или',
			HcsEmergency3BarLink: 'Баре',
			HcsEmergency3d:
				'; с переломами и травмами в районе Боко-Которского залива часто едут сразу в',
			HcsEmergency3RisanLink: 'ортопедическую больницу в Рисане',
			HcsEmergency3e: ', либо в hitna pomoć при местном доме здравля.',
			HcsEmergency4:
			...
			HcsState1a:
				'Государственная медицина устроена в три уровня, плюс специализированные больницы (ортопедия в ',
			HcsState1RisanLink: 'Рисане',
			HcsState1b: ', пульмонология в ',
			HcsState1BrezovikLink: 'Брезовике',
			HcsState1b2: ', психиатрия в ',
			HcsState1DobrotaLink: 'Доброте',
			HcsState1c: '):',
			HcsStateLevel1:
				'Dom zdravlja — центр первичной помощи в каждом муниципалитете: терапевты, педиатры, гинекологи, базовая диагностика, прививки;',
			HcsStateLevel2a: 'Opšta bolnica — общие больницы в',
			HcsStateLevel2BarLink: 'Баре',
			HcsStateLevel2b: ',',
			HcsStateLevel2KotorLink: 'Которе',
			HcsStateLevel2c: ', ',
			HcsStateLevel2NiksicLink: 'Никшиче',
			HcsStateLevel2c2: ', ',
			HcsStateLevel2BeraneLink: 'Беране',
			HcsStateLevel2c3: ',',
			HcsStateLevel2BijeloPoljeLink: 'Биело-Поле',
			HcsStateLevel2d: ',',
			HcsStateLevel2CetinjeLink: 'Цетине',
			HcsStateLevel2e: ' и ',
			HcsStateLevel2PljevljaLink: 'Плевле',
			HcsStateLevel2e2: ';',
			HcsStateLevel3Pre: '',
			HcsStateLevel3KccgLink: 'Klinički centar Crne Gore (KCCG)',
			HcsStateLevel3a:
				' в Подгорице — главная многопрофильная больница страны, куда направляют сложные случаи.',
			HcsState2:
				'Первичное звено построено вокруг izabrani doktor — «выбранного врача», к которому вы прикрепляетесь в своём доме здравля. Он лечит, выписывает рецепты и направления (uput) к специалистам и на диагностику, сам записывает вас к специалисту. Правда, к некоторым специалистам и на отдельные обследования есть очереди — списки ожидания публикуют больницы и фонд.',
			...
			HcsKnjizica3:
				'Важный практический нюанс, который на деле блокирует получение книжицы почти всем иностранцам: быть застрахованным в двух странах нельзя, и при первичном оформлении фонд требует подтверждение отказа от медстраховки в стране гражданства — а такую справку выдают очень немногие страны. Кроме того, книжица не положена иностранцам с ВНЖ по недвижимости, владельцам фирм без трудоустройства и цифровым кочевникам — для них в законе просто нет основания, а возможность добровольно «вступить» в госстраховку за взнос в новый закон не перенесли.',
			HcsKnjizica4:
			...
			HcsForeigners4:
				'У России, Украины, Казахстана и большинства других стран нет действующих соглашений о медицинской помощи с Черногорией. Гражданам этих стран остаётся платная медицина или частная страховка.',

			HcsInsurance1a:
				'Частные (добровольные) страховки продают местные страховщики —',
			HcsInsurance1SavaLink: 'Sava',
			HcsInsurance1b: ',',
			HcsInsurance1LovcenLink: 'Lovćen',
			HcsInsurance1c: ',',
		...
		'sr': {
			...
			HcsEmergency3a: 'Za ozbiljna stanja glavna adresa je Urgentni centar',
			HcsEmergency3KccgLink: 'Kliničkog centra Crne Gore (KCCG)',
			HcsEmergency3b:
				' u Podgorici, otvoren 24/7. Na primorju se akutni slučajevi voze u prijemna odjeljenja opštih bolnica u',
			HcsEmergency3KotorLink: 'Kotoru',
			HcsEmergency3c: ' ili',
			HcsEmergency3BarLink: 'Baru',
			HcsEmergency3d:
				'; kod preloma i povreda u okolini Bokokotorskog zaliva često se ide direktno u',
			HcsEmergency3RisanLink: 'ortopedsku bolnicu u Risnu',
			HcsEmergency3e: ', ili u hitnu pomoć pri lokalnom domu zdravlja.',
			HcsEmergency4:
			...
			HcsState1a:
				'Državno zdravstvo ima tri nivoa, uz specijalne bolnice (ortopedija u ',
			HcsState1RisanLink: 'Risnu',
			HcsState1b: ', plućne bolesti u ',
			HcsState1BrezovikLink: 'Brezoviku',
			HcsState1b2: ', psihijatrija u ',
			HcsState1DobrotaLink: 'Dobroti',
			HcsState1c: '):',
			HcsStateLevel1:
			...
			HcsStateLevel2a: 'Opšta bolnica — u',
			HcsStateLevel2BarLink: 'Baru',
			HcsStateLevel2b: ',',
			HcsStateLevel2KotorLink: 'Kotoru',
			HcsStateLevel2c: ', ',
			HcsStateLevel2NiksicLink: 'Nikšiću',
			HcsStateLevel2c2: ', ',
			HcsStateLevel2BeraneLink: 'Beranama',
			HcsStateLevel2c3: ',',
			HcsStateLevel2BijeloPoljeLink: 'Bijelom Polju',
			HcsStateLevel2d: ',',
			HcsStateLevel2CetinjeLink: 'Cetinju',
			HcsStateLevel2e: ' i ',
			HcsStateLevel2PljevljaLink: 'Pljevljima',
			HcsStateLevel2e2: ';',
			HcsStateLevel3Pre: '',
			HcsStateLevel3KccgLink: 'Klinički centar Crne Gore (KCCG)',
			HcsStateLevel3a:
				' u Podgorici — glavna multidisciplinarna bolnica u koju se upućuju složeni slučajevi.',
			HcsState2:
			...
			HcsKnjizica3:
				'Važna praktična prepreka koja u praksi blokira dobijanje knjižice gotovo svim strancima: ne možete biti osigurani u dvije države istovremeno, pa pri prvoj registraciji Fond traži potvrdu o odjavi zdravstvenog osiguranja u zemlji porijekla — a takvu potvrdu izdaje vrlo malo zemalja. Osim toga, knjižica ne pripada strancima sa boravkom po osnovu nekretnine, vlasnicima firmi bez zaposlenja i digitalnim nomadima — za njih u zakonu jednostavno ne postoji osnov, a mogućnost dobrovoljnog ulaska u državno osiguranje uz uplatu doprinosa nije prenijeta u važeći zakon.',
			HcsKnjizica4:
			...
			HcsForeigners4:
				'Rusija, Ukrajina, Kazahstan i većina drugih zemalja nemaju sporazum o zdravstvenoj zaštiti sa Crnom Gorom. Državljanima tih zemalja ostaje plaćena medicina ili privatno osiguranje.',

			HcsInsurance1a:
				'Privatna (dobrovoljna) osiguranja prodaju lokalni osiguravači —',
			HcsInsurance1SavaLink: 'Sava',
			HcsInsurance1b: ',',
			HcsInsurance1LovcenLink: 'Lovćen',
			HcsInsurance1c: ',',
		...
		'sr-cyrl': {
			...
			HcsEmergency3a: 'За озбиљна стања главна адреса је Ургентни центар',
			HcsEmergency3KccgLink: 'Клиничког центра Црне Горе (КЦЦГ)',
			HcsEmergency3b:
				' у Подгорици, отворен 24/7. На приморју се акутни случајеви возе у пријемна одјељења општих болница у',
			HcsEmergency3KotorLink: 'Котору',
			HcsEmergency3c: ' или',
			HcsEmergency3BarLink: 'Бару',
			HcsEmergency3d:
				'; код прелома и повреда у околини Бококоторског залива често се иде директно у',
			HcsEmergency3RisanLink: 'ортопедску болницу у Рисну',
			HcsEmergency3e: ', или у хитну помоћ при локалном дому здравља.',
			HcsEmergency4:
			...
			HcsState1a:
				'Државно здравство има три нивоа, уз специјалне болнице (ортопедија у ',
			HcsState1RisanLink: 'Рисну',
			HcsState1b: ', плућне болести у ',
			HcsState1BrezovikLink: 'Брезовику',
			HcsState1b2: ', психијатрија у ',
			HcsState1DobrotaLink: 'Доброти',
			HcsState1c: '):',
			HcsStateLevel1:
			...
			HcsStateLevel2a: 'Општа болница — у',
			HcsStateLevel2BarLink: 'Бару',
			HcsStateLevel2b: ',',
			HcsStateLevel2KotorLink: 'Котору',
			HcsStateLevel2c: ', ',
			HcsStateLevel2NiksicLink: 'Никшићу',
			HcsStateLevel2c2: ', ',
			HcsStateLevel2BeraneLink: 'Беранама',
			HcsStateLevel2c3: ',',
			HcsStateLevel2BijeloPoljeLink: 'Бијелом Пољу',
			HcsStateLevel2d: ',',
			HcsStateLevel2CetinjeLink: 'Цетињу',
			HcsStateLevel2e: ' и ',
			HcsStateLevel2PljevljaLink: 'Пљевљима',
			HcsStateLevel2e2: ';',
			HcsStateLevel3Pre: '',
			HcsStateLevel3KccgLink: 'Клинички центар Црне Горе (КЦЦГ)',
			HcsStateLevel3a:
				' у Подгорици — главна мултидисциплинарна болница у коју се упућују сложени случајеви.',
			HcsState2:
			...
			HcsKnjizica1SlListLink: '„Службени лист ЦГ“ 145/21',
			HcsKnjizica1b: ').',
			HcsKnjizica2:
			...
			HcsKnjizica3:
				'Важна практична препрека која у пракси блокира добијање књижице готово свим странцима: не можете бити осигурани у двије државе истовремено, па при првој регистрацији Фонд тражи потврду о одјави здравственог осигурања у земљи поријекла — а такву потврду издаје врло мало земаља. Осим тога, књижица не припада странцима са боравком по основу некретнине, власницима фирми без запослења и дигиталним номадима — за њих у закону једноставно не постоји основ, а могућност добровољног уласка у државно осигурање уз уплату доприноса није пренијета у важећи закон.',
			HcsKnjizica4:
			...
			HcsWithout2:
				'Приватне клинике и ординације свакодневни су избор већине неосигураних странаца: преглед љекара опште праксе или специјалисте кошта 30–50 €, комплетна посјета са ултразвуком и анализама око 80 €. Стационар и операционе сале има само неколико приватних клиника — код акутног хируршког стања приватна клиника ће вас највјероватније преусмјерити у државну болницу.',
			HcsWithout3:
			...
			HcsForeigners4:
				'Русија, Украјина, Казахстан и већина других земаља немају споразум о здравственој заштити са Црном Гором. Држављанима тих земаља остаје плаћена медицина или приватно осигурање.',

			HcsInsurance1a:
				'Приватна (добровољна) осигурања продају локални осигуравачи —',
			HcsInsurance1SavaLink: 'Sava',
			HcsInsurance1b: ',',
			HcsInsurance1LovcenLink: 'Lovćen',
			HcsInsurance1c: ',',
		...
		'de': {
			...
			HcsEmergency3a:
				'Bei ernsten Zuständen ist die wichtigste Adresse das Urgentni centar des',
			HcsEmergency3KccgLink: 'Klinischen Zentrums von Montenegro (KCCG)',
			HcsEmergency3b:
				' in Podgorica, rund um die Uhr geöffnet. An der Küste fährt man mit akuten Fällen in die Notaufnahmen der allgemeinen Krankenhäuser in',
			HcsEmergency3KotorLink: 'Kotor',
			HcsEmergency3c: ' oder',
			HcsEmergency3BarLink: 'Bar',
			HcsEmergency3d:
				'; bei Brüchen und Verletzungen rund um die Bucht von Kotor fährt man oft direkt in das',
			HcsEmergency3RisanLink: 'orthopädische Krankenhaus in Risan',
			HcsEmergency3e: ', oder zur hitna pomoć am örtlichen dom zdravlja.',
			HcsEmergency4:
			...
			HcsState1a:
				'Das staatliche Gesundheitswesen hat drei Ebenen, dazu Spezialkliniken (Orthopädie in ',
			HcsState1RisanLink: 'Risan',
			HcsState1b: ', Lungenheilkunde in ',
			HcsState1BrezovikLink: 'Brezovik',
			HcsState1b2: ', Psychiatrie in ',
			HcsState1DobrotaLink: 'Dobrota',
			HcsState1c: '):',
			HcsStateLevel1:
			...
			HcsStateLevel2a: 'Opšta bolnica — allgemeine Krankenhäuser in',
			HcsStateLevel2BarLink: 'Bar',
			HcsStateLevel2b: ',',
			HcsStateLevel2KotorLink: 'Kotor',
			HcsStateLevel2c: ', ',
			...
			HcsStateLevel3KccgLink: 'Klinički centar Crne Gore (KCCG)',
			HcsStateLevel3a:
				' in Podgorica — das wichtigste multidisziplinäre Krankenhaus des Landes, an das komplexe Fälle überwiesen werden.',
			HcsState2:
			...
			HcsKnjizica3:
				'Ein wichtiger praktischer Haken, der in der Praxis fast alle Ausländer vom Erhalt der knjižica ausschließt: Man kann nicht in zwei Ländern gleichzeitig versichert sein, daher verlangt der Fonds bei der Erstanmeldung einen Nachweis der Abmeldung von der Krankenversicherung im Herkunftsland — und nur sehr wenige Länder stellen eine solche Bescheinigung überhaupt aus. Darüber hinaus sieht das Gesetz schlicht keine Grundlage für Ausländer mit Aufenthalt auf Basis von Immobilienbesitz, Firmeninhaber ohne Anstellung und digitale Nomaden vor, und die frühere Möglichkeit, sich freiwillig gegen Beitrag einzukaufen, wurde nicht ins geltende Gesetz übernommen.',
			HcsKnjizica4:
			...
			HcsWithout2:
				'Privatkliniken und Praxen sind die Alltagswahl der meisten unversicherten Ausländer: Eine Konsultation beim Allgemeinarzt oder Facharzt kostet 30–50 €, ein umfassender Besuch mit Ultraschall und Laboranalysen etwa 80 €. Nur wenige Privatkliniken verfügen über Betten und Operationssäle — bei einem akuten chirurgischen Notfall wird eine Privatklinik Sie höchstwahrscheinlich an ein staatliches Krankenhaus verweisen.',
			HcsWithout3:
			...
			HcsForeigners4:
				'Russland, die Ukraine, Kasachstan und die meisten anderen Länder haben kein Abkommen über medizinische Versorgung mit Montenegro. Bürgern dieser Länder bleiben bezahlte Medizin oder eine private Versicherung.',

			HcsInsurance1a:
				'Private (freiwillige) Krankenversicherungen bieten lokale Versicherer an —',
			HcsInsurance1SavaLink: 'Sava',
			HcsInsurance1b: ',',
			HcsInsurance1LovcenLink: 'Lovćen',
			HcsInsurance1c: ',',
		...
		'tr': {
			...
			HcsEmergency3a: "Ciddi durumlarda ana adres, Podgorica'daki",
			HcsEmergency3KccgLink: "Karadağ Klinik Merkezi'nin (KCCG)",
			HcsEmergency3b: " 7/24 açık Urgentni centar'ıdır. Sahil şehirlerinde akut vakalar",
			HcsEmergency3KotorLink: 'Kotor',
			HcsEmergency3c: ' veya',
			HcsEmergency3BarLink: 'Bar',
			HcsEmergency3d:
				" genel hastanelerinin acil servislerine götürülür; Kotor Körfezi çevresindeki kırık ve travmalarda çoğunlukla doğrudan",
			HcsEmergency3RisanLink: "Risan'daki ortopedi hastanesine",
			HcsEmergency3e: " gidilir, ya da yerel dom zdravlja'daki hitna pomoć'a başvurulur.",
			HcsEmergency4:
			...
			HcsState1a:
				'Devlet sağlık sistemi üç kademelidir; ayrıca uzmanlaşmış hastaneler vardır (',
			HcsState1RisanLink: 'Risan’da',
			HcsState1b: ' ortopedi, ',
			HcsState1BrezovikLink: 'Brezovik’te',
			HcsState1b2: ' göğüs hastalıkları, ',
			HcsState1DobrotaLink: 'Dobrota’da',
			HcsState1c: ' psikiyatri):',
			HcsStateLevel1:
			...
			HcsStateLevel2CetinjeLink: 'Cetinje',
			HcsStateLevel2e: ' ve ',
			HcsStateLevel2PljevljaLink: 'Pljevlja’daki',
			HcsStateLevel2e2: ' genel hastaneler;',
			HcsStateLevel3Pre: 'Podgorica’daki ',
			HcsStateLevel3KccgLink: 'Klinički centar Crne Gore (KCCG)',
			HcsStateLevel3a:
				' — ülkenin karmaşık vakaların sevk edildiği ana çok branşlı hastanesi.',
			HcsState2:
			...
			HcsKnjizica3:
				'Pratikte neredeyse tüm yabancıların karneyi almasını engelleyen önemli bir ayrıntı: aynı anda iki ülkede sigortalı olunamaz, bu yüzden ilk kayıtta Fon, kendi ülkenizdeki sağlık sigortasından çıkış belgesini ister — ancak bu tür bir belgeyi çok az ülke düzenler. Bunun yanında, gayrimenkul sahipliğine dayalı oturum izni olanlar, istihdam olmadan şirket sahipleri ve dijital göçebeler için kanunda zaten bir dayanak yoktur ve prim ödeyerek gönüllü katılım imkânı yürürlükteki kanuna taşınmamıştır.',
			HcsKnjizica4:
			...
			HcsWithout2:
				'Özel klinikler ve muayenehaneler sigortasız yabancıların günlük tercihidir: pratisyen veya uzman muayenesi 30–50 €, ultrason ve tahlillerle kapsamlı bir ziyaret yaklaşık 80 € tutar. Yataklı servis ve ameliyathane yalnızca birkaç özel klinikte vardır — akut cerrahi bir durumda özel klinik sizi büyük olasılıkla devlet hastanesine yönlendirir.',
			HcsWithout3:
			...
			HcsForeigners4:
				'Rusya, Ukrayna, Kazakistan ve diğer ülkelerin çoğunun Karadağ ile sağlık anlaşması yoktur. Bu ülkelerin vatandaşlarına ücretli tıp veya özel sigorta kalır.',

			HcsInsurance1a:
				'Özel (gönüllü) sağlık sigortalarını yerel sigortacılar sunar —',
			HcsInsurance1SavaLink: 'Sava',
			HcsInsurance1b: ',',
			HcsInsurance1LovcenLink: 'Lovćen',
			HcsInsurance1c: ',',
