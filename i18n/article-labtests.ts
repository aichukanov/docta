...
export default {
	messages: {
		...
		'ru': {
			...
			'LtcPrivate1MojLabLink': 'Moj Lab',
			'LtcPrivate1b':
				' (девять городов, от Подгорицы и Будвы до Улциня), в Подгорице работают ',
			'LtcPrivate1InVitroLink': 'In Vitro',
			'LtcPrivate1c': ' и ',
			'LtcPrivate1BonaLabLink': 'Bona-lab prima',
		...
		'sr': {
			...
			'LtcPrivate1MojLabLink': 'Moj Lab',
			'LtcPrivate1b':
				' (devet gradova, od Podgorice i Budve do Ulcinja); u Podgorici rade ',
			'LtcPrivate1InVitroLink': 'In Vitro',
			'LtcPrivate1c': ' i ',
			'LtcPrivate1BonaLabLink': 'Bona-lab prima',
		...
		'sr-cyrl': {
			...
			'LtcPrivate1MojLabLink': 'Moj Lab',
			'LtcPrivate1b':
				' (девет градова, од Подгорице и Будве до Улциња); у Подгорици раде ',
			'LtcPrivate1InVitroLink': 'In Vitro',
			'LtcPrivate1c': ' и ',
			'LtcPrivate1BonaLabLink': 'Bona-lab prima',
		...
		'de': {
			...
			'LtcPrivate1MojLabLink': 'Moj Lab',
			'LtcPrivate1b':
				' (neun Städte, von Podgorica und Budva bis Ulcinj); in Podgorica arbeiten ',
			'LtcPrivate1InVitroLink': 'In Vitro',
			'LtcPrivate1c': ' und ',
			'LtcPrivate1BonaLabLink': 'Bona-lab prima',
		...
		'tr': {
			...
			'LtcToc_results':
				'Sonuçlar nasıl okunur: birimler ve referans aralıkları',
			...
			'LtcPrivate1b':
				" (Podgorica ve Budva'dan Ulcinj'e dokuz şehir); Podgorica'da ",
			'LtcPrivate1InVitroLink': 'In Vitro',
			'LtcPrivate1c': ' ve ',
			'LtcPrivate1BonaLabLink': 'Bona-lab prima',
