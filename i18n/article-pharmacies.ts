...
export default {
	messages: {
		...
		'ru': {
			...
			PhaPharmacies4:
				'Граница «рецептурное/безрецептурное» проходит не так, как вы, возможно, привыкли. Таблетированные антибиотики, снотворные, антидепрессанты и большинство «серьёзных» препаратов — строго по рецепту, уговорить фармацевта не выйдет. Зато обезболивающие (ибупрофен — здесь это чаще Brufen — и парацетамол), многие мази, капли и даже, по опыту форумов, ампулы адреналина продаются свободно. Фармацевты обычно охотно помогают подобрать аналог; на побережье многие говорят по-английски.',
