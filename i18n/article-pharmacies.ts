	...
	messages: {
		'en': {
			...
			'PhaToc_prescriptions':
				'Prescriptions: Montenegrin only — paper or electronic',
		...
		'ru': {
			...
			'PhaToc_prescriptions':
				'Рецепты: только черногорские — бумажные или электронные',
			...
			'PhaAnalogs1c':
				'. По действующему веществу фармацевт подберёт местный аналог.',
			'PhaAnalogs2':
		...
		'sr': {
			...
			'PhaToc_prescriptions':
				'Recepti: samo crnogorski — papirni ili elektronski',
			...
			'PhaAnalogs1LevothyroxineLink': 'levotiroksin',
			'PhaAnalogs1c':
				'. Po aktivnoj supstanci farmaceut će naći lokalni analog.',
			'PhaAnalogs2':
		...
		'sr-cyrl': {
			...
			'PhaToc_prescriptions':
				'Рецепти: само црногорски — папирни или електронски',
			...
			'PhaAnalogs1c':
				'. По активној супстанци фармацеут ће наћи локални аналог.',
			'PhaAnalogs2':
		...
		'de': {
			...
			'PhaToc_prescriptions':
				'Rezepte: nur montenegrinisch — Papier oder elektronisch',
			...
			'PhaAnalogs1IbuprofenLink': 'ibuprofen',
			'PhaAnalogs1b':
				' (das lokale Pendant heißt Brufen), nicht „Euthyrox“, sondern ',
			'PhaAnalogs1LevothyroxineLink': 'levothyroxin',
			'PhaAnalogs1c':
				'. Anhand des Wirkstoffs findet der Apotheker das lokale Pendant.',
			'PhaAnalogs2':
			...
			'PhaSourcesCatalogLink':
				'finden Sie einen Arzt, der Ihre Sprache spricht',
			'PhaSourcesCatalogEnd': '.',
		...
		'tr': {
			...
			'PhaToc_prescriptions':
				'Reçeteler: yalnızca Karadağ reçetesi — kâğıt veya elektronik',
