...
export default {
	messages: {
		'en': {
			...
			RipCoverage4:
				'Two more observations from users: Sava has the reputation of paying claims more reliably than Lovćen, and a new policy will not keep reimbursing treatment that started under an expired old one — an ongoing case ends with the policy it began under.',
			RipCoverage5:
		...
		'ru': {
			...
			RipCoverage4:
				'Ещё два наблюдения пользователей: у Sava репутация страховщика, который платит по случаям надёжнее, чем Lovćen, а новый полис не продолжит возмещать лечение, начатое при старом истёкшем, — начатый случай закрывается вместе с полисом, при котором он начался.',
			RipCoverage5:
		...
		'sr': {
			...
			RipCoverage4:
				'Još dva zapažanja korisnika: Sava ima reputaciju osiguravača koji isplaćuje pouzdanije od Lovćena, a nova polisa neće nastaviti da refundira liječenje započeto uz staru isteklu — započeti slučaj zatvara se sa polisom uz koju je počeo.',
			RipCoverage5:
		...
		'sr-cyrl': {
			...
			RipCoverage4:
				'Још два запажања корисника: Sava има репутацију осигуравача који исплаћује поузданије од Lovćena, а нова полиса неће наставити да рефундира лијечење започето уз стару истеклу — започети случај затвара се са полисом уз коју је почео.',
			RipCoverage5:
		...
		'de': {
			...
			RipCoverage4:
				'Zwei weitere Beobachtungen von Nutzern: Sava hat den Ruf, Schadensfälle zuverlässiger zu bezahlen als Lovćen, und eine neue Police erstattet keine Behandlung weiter, die unter einer abgelaufenen alten begann — ein laufender Fall endet mit der Police, unter der er begonnen hat.',
			RipCoverage5:
		...
		'tr': {
			...
			RipCoverage4:
				"Kullanıcılardan iki gözlem daha: Sava'nın hasarları Lovćen'den daha güvenilir ödediği yönünde bir ünü var; yeni poliçe, süresi dolmuş eski poliçe döneminde başlayan tedaviyi geri ödemeye devam etmez — açılan vaka, başladığı poliçeyle kapanır.",
			RipCoverage5:
