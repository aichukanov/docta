// Контент статьи «Заболел в отпуске в Черногории: куда обращаться туристу».
// Факты сверены с законом о здравоохранении (Zakon o zdravstvenoj zaštiti, čl. 12),
// инструкцией FZOCG для иностранных застрахованных (fzocg.me), памяткой gov.uk
// о взаимной медицинской помощи, памяткой DVKA «Urlaub in Montenegro» и данными
...
export default {
	messages: {
		'en': {
			...
			'ThcAgreements2':
				'The mechanics: before travelling, get an entitlement certificate from your home fund (the German, Austrian, Slovenian and Luxembourgish insured can simply use their EHIC as that document). In Montenegro you exchange it at any FZOCG branch for the INO 1 health list — and are then treated in state institutions like a local patient. In a genuine emergency they must treat you first; the paperwork can be sorted out afterwards.',
			'ThcAgreements3':
			...
			'ThcPharmacies1':
				'Pharmacies (apoteka) are on every corner in resort towns, and in season many work late and on Sundays. Painkillers, antipyretics, rehydration salts, ear and nose drops, sunburn sprays and motion-sickness pills are sold freely. Antibiotic tablets are strictly prescription-only — and pharmacies do not accept foreign prescriptions, only Montenegrin ones. If you need prescription medication, a paid visit to the turistička ambulanta or a private doctor solves it: after the consultation the doctor issues a local prescription — at a private clinic a paper one with a stamp.',
			'ThcPharmacies2':
			...
			'ThcSources0':
				'The information is current as of July 2026 and describes typical situations — it is not a substitute for seeing a doctor. Rules and prices change — verify anything important against official sources:',
			'ThcSourcesPhones':
				'Emergency numbers: 124 — ambulance, 112 — single European emergency number (122 — police, 123 — fire);',
			'ThcSourcesFzo':
				'Health Insurance Fund of Montenegro (FZOCG) — procedures under bilateral agreements and the INO 1 form: fzocg.me;',
			'ThcSourcesGovUk':
				'UK residents — official guidance on reciprocal healthcare with Montenegro: gov.uk;',
			'ThcSourcesDvka':
				'German insured — the DVKA leaflet “Urlaub in Montenegro” on what the agreement does and does not cover: dvka.de.',
			'ThcSourcesGuide':
				'Staying in Montenegro longer than a holiday? Read our detailed guide on',
		...
		'ru': {
			...
			'ThcAgreements2':
				'Механика такая: перед поездкой возьмите в своём фонде справку-основание (застрахованным в Германии, Австрии, Словении и Люксембурге достаточно их карты EHIC как документа). В Черногории её обменивают в любом филиале FZOCG на здравственный лист INO 1 — и дальше вы лечитесь в госучреждениях как местный пациент. В настоящей экстренной ситуации помощь обязаны оказать сразу, а бумаги можно оформить потом.',
			'ThcAgreements3':
			...
			'ThcSources0':
				'Информация актуальна на июль 2026 года и описывает типичные ситуации — она не заменяет консультацию врача. Правила и цены меняются — важное сверяйте с официальными источниками:',
			'ThcSourcesPhones':
				'Экстренные номера: 124 — скорая, 112 — единый европейский номер (122 — полиция, 123 — пожарные);',
			'ThcSourcesFzo':
				'Фонд медицинского страхования Черногории (FZOCG) — процедуры по двусторонним соглашениям и форма INO 1: fzocg.me;',
			'ThcSourcesGovUk':
				'Для жителей Великобритании — официальная памятка о взаимной медицинской помощи с Черногорией: gov.uk;',
			'ThcSourcesDvka':
				'Для застрахованных в Германии — памятка DVKA «Urlaub in Montenegro» о том, что покрывает и не покрывает соглашение: dvka.de.',
			'ThcSourcesGuide':
				'Остаётесь в Черногории дольше отпуска? Прочитайте наш подробный гид о том,',
		...
		'sr': {
			...
			'ThcToc_insurance':
				'Putno osiguranje: šta provjeriti i kako ga koristiti',
			...
			'ThcAgreements2':
				'Mehanika je sljedeća: prije putovanja uzmite potvrdu svog fonda (osiguranicima iz Njemačke, Austrije, Slovenije i Luksemburga dovoljna je njihova EHIC kartica kao dokument). U Crnoj Gori se potvrda u bilo kojoj filijali FZOCG zamjenjuje za zdravstveni list INO 1 — i dalje se liječite u državnim ustanovama kao domaći pacijent. U stvarnoj hitnoj situaciji pomoć su dužni da pruže odmah, a papiri se mogu srediti naknadno.',
			'ThcAgreements3':
			...
			'ThcPharmacies1':
				'Apoteka u turističkim mjestima ima na svakom koraku, a u sezoni mnoge rade do kasno i nedjeljom. Analgetici, antipiretici, rehidratacione soli, kapi za uši i nos, sprejevi za opekotine od sunca i tablete protiv mučnine prodaju se slobodno. Antibiotici u tabletama izdaju se strogo na recept, pri čemu apoteke ne prihvataju strane recepte, već samo crnogorske. Ako vam treba lijek na recept, pitanje rješava plaćeni pregled u turističkoj ambulanti ili kod privatnog ljekara: poslije konsultacije ljekar izdaje lokalni recept — u privatnoj klinici papirni, sa pečatom.',
			'ThcPharmacies2':
			...
			'ThcSources0':
				'Informacije važe za jul 2026. i opisuju tipične situacije — nisu zamjena za pregled ljekara. Pravila i cijene se mijenjaju — važne stvari provjerite u zvaničnim izvorima:',
			'ThcSourcesPhones':
				'Brojevi za hitne slučajeve: 124 — hitna pomoć, 112 — jedinstveni evropski broj (122 — policija, 123 — vatrogasci);',
			'ThcSourcesFzo':
				'Fond za zdravstveno osiguranje Crne Gore (FZOCG) — procedure po bilateralnim sporazumima i obrazac INO 1: fzocg.me;',
			'ThcSourcesGovUk':
				'Za stanovnike Velike Britanije — zvanično uputstvo o recipročnoj zdravstvenoj zaštiti sa Crnom Gorom: gov.uk;',
			'ThcSourcesDvka':
				'Za osiguranike iz Njemačke — uputstvo DVKA „Urlaub in Montenegro“ o tome šta sporazum pokriva, a šta ne: dvka.de.',
			'ThcSourcesGuide':
				'Ostajete u Crnoj Gori duže od odmora? Pročitajte naš detaljni vodič o tome',
			'ThcSourcesGuideLink': 'kako funkcioniše zdravstvo u Crnoj Gori',
			'ThcSourcesGuideEnd': '.',
		},
		'sr-cyrl': {
			'TouristHealthcareTitle':
			...
			'ThcAgreements2':
				'Механика је сљедећа: прије путовања узмите потврду свог фонда (осигураницима из Њемачке, Аустрије, Словеније и Луксембурга довољна је њихова EHIC картица као документ). У Црној Гори се потврда у било којој филијали ФЗОЦГ замјењује за здравствени лист ИНО 1 — и даље се лијечите у државним установама као домаћи пацијент. У стварној хитној ситуацији помоћ су дужни да пруже одмах, а папири се могу средити накнадно.',
			'ThcAgreements3':
			...
			'ThcPharmacies1':
				'Апотека у туристичким мјестима има на сваком кораку, а у сезони многе раде до касно и недјељом. Аналгетици, антипиретици, рехидратационе соли, капи за уши и нос, спрејеви за опекотине од сунца и таблете против мучнине продају се слободно. Антибиотици у таблетама издају се строго на рецепт, при чему апотеке не прихватају стране рецепте, већ само црногорске. Ако вам треба лијек на рецепт, питање рјешава плаћени преглед у туристичкој амбуланти или код приватног љекара: послије консултације љекар издаје локални рецепт — у приватној клиници папирни, са печатом.',
			'ThcPharmacies2':
			...
			'ThcSources0':
				'Информације важе за јул 2026. и описују типичне ситуације — нису замјена за преглед љекара. Правила и цијене се мијењају — важне ствари провјерите у званичним изворима:',
			'ThcSourcesPhones':
				'Бројеви за хитне случајеве: 124 — хитна помоћ, 112 — јединствени европски број (122 — полиција, 123 — ватрогасци);',
			'ThcSourcesFzo':
				'Фонд за здравствено осигурање Црне Горе (ФЗОЦГ) — процедуре по билатералним споразумима и образац ИНО 1: fzocg.me;',
			'ThcSourcesGovUk':
				'За становнике Велике Британије — званично упутство о реципрочној здравственој заштити са Црном Гором: gov.uk;',
			'ThcSourcesDvka':
				'За осигуранике из Њемачке — упутство DVKA „Urlaub in Montenegro“ о томе шта споразум покрива, а шта не: dvka.de.',
			'ThcSourcesGuide':
				'Остајете у Црној Гори дуже од одмора? Прочитајте наш детаљни водич о томе',
		...
		'de': {
			...
			'ThcAgreements2':
				'So funktioniert es: Besorgen Sie sich vor der Reise eine Anspruchsbescheinigung Ihrer Kasse (deutschen, österreichischen, slowenischen und luxemburgischen Versicherten genügt die EHIC als Nachweis). In Montenegro tauschen Sie sie in einer beliebigen FZOCG-Filiale gegen den Behandlungsschein INO 1 — danach werden Sie in staatlichen Einrichtungen wie ein einheimischer Patient behandelt. In einem echten Notfall muss zuerst behandelt werden; die Papiere lassen sich nachreichen.',
			'ThcAgreements3':
			...
			'ThcSources0':
				'Stand der Informationen: Juli 2026. Sie beschreiben typische Situationen und ersetzen keinen ärztlichen Rat. Regeln und Preise ändern sich — prüfen Sie Wichtiges anhand offizieller Quellen:',
			'ThcSourcesPhones':
				'Notrufnummern: 124 — Rettungsdienst, 112 — einheitliche europäische Nummer (122 — Polizei, 123 — Feuerwehr);',
			'ThcSourcesFzo':
				'Krankenversicherungsfonds Montenegros (FZOCG) — Verfahren nach bilateralen Abkommen und das Formular INO 1: fzocg.me;',
			'ThcSourcesGovUk':
				'Für Einwohner Großbritanniens — offizielle Hinweise zur gegenseitigen Gesundheitsversorgung mit Montenegro: gov.uk;',
			'ThcSourcesDvka':
				'Für deutsche Versicherte — das DVKA-Merkblatt „Urlaub in Montenegro“ dazu, was das Abkommen deckt und was nicht: dvka.de.',
			'ThcSourcesGuide':
				'Bleiben Sie länger als einen Urlaub in Montenegro? Lesen Sie unseren ausführlichen Leitfaden dazu,',
			'ThcSourcesGuideLink':
		...
		'tr': {
			...
			'ThcWhere4a':
				"Gerçekten ciddi bir durumda — apandisit şüphesi, göğüs ağrısı, ağır kaza — ana adres Podgorica'daki ",
			...
			'ThcAgreements1':
				"Karadağ AB üyesi değildir, bu yüzden Avrupa Sağlık Sigortası Kartı burada tek başına geçerli değildir. Ancak ikili sosyal güvenlik anlaşmaları geçerlidir: Sırbistan, Slovenya, Hırvatistan, Bosna-Hersek, Kuzey Makedonya, Avusturya, Almanya, Çekya, Slovakya, Macaristan, Hollanda, Belçika, Lüksemburg, İtalya, Türkiye ve Bulgaristan'da sigortalı olanlara devlet kurumlarında acil yardım, kendi ülkelerindeki fonun hesabına verilir.",
			'ThcAgreements2':
				"İşleyiş şöyle: yolculuktan önce kendi fonunuzdan hak belgesi alın (Almanya, Avusturya, Slovenya ve Lüksemburg sigortalılarına belge olarak EHIC kartları yeterlidir). Karadağ'da bu belge herhangi bir FZOCG şubesinde INO 1 sağlık belgesiyle değiştirilir — sonrasında devlet kurumlarında yerli hasta gibi tedavi görürsünüz. Gerçek bir acil durumda önce yardım etmek zorundadırlar; evraklar sonradan tamamlanabilir.",
			'ThcAgreements3':
			...
			'ThcSources0':
				'Bilgiler Temmuz 2026 itibarıyla günceldir; tipik durumları anlatır ve doktor muayenesinin yerini tutmaz. Kurallar ve fiyatlar değişir — önemli konuları resmi kaynaklardan doğrulayın:',
			'ThcSourcesPhones':
				'Acil numaralar: 124 — ambulans, 112 — ortak Avrupa numarası (122 — polis, 123 — itfaiye);',
			'ThcSourcesFzo':
				'Karadağ Sağlık Sigortası Fonu (FZOCG) — ikili anlaşma prosedürleri ve INO 1 formu: fzocg.me;',
			'ThcSourcesGovUk':
