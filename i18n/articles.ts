export default {
	messages: {
		...
		'sr-cyrl': {
			...
			RussianSpeakingDoctorsIntro1:
				'Ако говорите руски и желите да разговарате о симптомима и лијечењу без језичке баријере, то је у Црној Гори сасвим оствариво: неки љекари наводе руски међу језицима на којима примају пацијенте. Испод је списак таквих љекара, груписан по специјалностима.',
			RussianSpeakingDoctorsIntro2:
