 ...
 * Тексты для страницы входа и регистрации
 */
...
export default {
	messages: {
		...
		'sr': {
			...
			// Podnaslovi
			chooseLoginMethod: 'Izaberite način prijavljivanja',
			createNewAccount: 'Kreirajte novi nalog',

			// Oznake i placeholder-i formi
			email: 'Email',
			password: 'Lozinka',
			name: 'Ime',
		...
		'de': {
			...
			// Untertitel
			chooseLoginMethod: 'Wählen Sie Ihre Anmeldemethode',
			createNewAccount: 'Neues Konto erstellen',

			// Formularfelder & Platzhalter
			email: 'E-Mail',
			password: 'Passwort',
			name: 'Name',
		...
		'tr': {
			...
			// Alt başlıklar
			chooseLoginMethod: 'Giriş yönteminizi seçin',
			createNewAccount: 'Yeni hesap oluştur',

			// Form etiketleri & placeholder'lar
			email: 'E-posta',
			password: 'Şifre',
			name: 'İsim',
		...
		'sr-cyrl': {
			...
			// Поднаслови
			chooseLoginMethod: 'Изаберите начин пријављивања',
			...
			noAccount: 'Немате налог? Региструјте се',
			haveAccount: 'Већ имате налог? Пријавите се',
