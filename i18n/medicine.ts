export default {
	messages: {
		'en': {
			...
			RestrictedRx: 'Restricted prescription',
			...
			FilterDispensingMode: 'Dispensing mode',
			FilterAnyDispensingMode: 'Any mode',
			FilterSearchDispensingMode: 'Search mode',
			FilterAtcGroup: 'Therapeutic group',
			FilterAnyAtcGroup: 'Any group',
			FilterSearchAtcGroup: 'Search group',
			FilterAtcClass: 'Pharmacological class',
			FilterAnyAtcClass: 'Any class',
			FilterSearchAtcClass: 'Search class',
		...
		'ru': {
			...
			RestrictedRx: 'Ограниченный рецепт',
			...
			FilterDispensingMode: 'Режим отпуска',
			FilterAnyDispensingMode: 'Любой режим',
			FilterSearchDispensingMode: 'Поиск режима',
			FilterAtcGroup: 'Терапевтическая группа',
			FilterAnyAtcGroup: 'Любая группа',
			FilterSearchAtcGroup: 'Поиск группы',
			FilterAtcClass: 'Фармакологический класс',
			FilterAnyAtcClass: 'Любой класс',
			FilterSearchAtcClass: 'Поиск класса',
		...
		'sr': {
			...
			FilterDispensingMode: 'Režim izdavanja',
			FilterAnyDispensingMode: 'Bilo koji režim',
			FilterSearchDispensingMode: 'Pretraži režim',
			FilterAtcGroup: 'Terapijska grupa',
			FilterAnyAtcGroup: 'Bilo koja grupa',
			FilterSearchAtcGroup: 'Pretraži grupu',
			FilterAtcClass: 'Farmakološka klasa',
			FilterAnyAtcClass: 'Bilo koja klasa',
			FilterSearchAtcClass: 'Pretraži klasu',
			...
			SortPopular: 'Prvo popularni',
			SortNameAsc: 'Po abecedi',
		...
		'de': {
			...
			RestrictedRx: 'Eingeschränktes Rezept',
			...
			FilterDispensingMode: 'Abgabemodus',
			FilterAnyDispensingMode: 'Alle Modi',
			FilterSearchDispensingMode: 'Modus suchen',
			FilterAtcGroup: 'Therapeutische Gruppe',
			FilterAnyAtcGroup: 'Alle Gruppen',
			FilterSearchAtcGroup: 'Gruppe suchen',
			FilterAtcClass: 'Wirkstoffklasse',
			FilterAnyAtcClass: 'Alle Klassen',
			FilterSearchAtcClass: 'Klasse suchen',
			...
			SortPopular: 'Beliebte zuerst',
			SortNameAsc: 'Alphabetisch',
		...
		'tr': {
			...
			FilterDispensingMode: 'Dağıtım modu',
			FilterAnyDispensingMode: 'Herhangi bir mod',
			FilterSearchDispensingMode: 'Mod ara',
			FilterAtcGroup: 'Terapötik grup',
			FilterAnyAtcGroup: 'Herhangi bir grup',
			FilterSearchAtcGroup: 'Grup ara',
			FilterAtcClass: 'Farmakolojik sınıf',
			FilterAnyAtcClass: 'Herhangi bir sınıf',
			FilterSearchAtcClass: 'Sınıf ara',
			...
			SortLabel: 'Sıralama',
			SortPopular: 'Önce popüler olanlar',
			SortNameAsc: 'Alfabetik',
		...
		'sr-cyrl': {
			...
			FilterDispensingMode: 'Режим издавања',
			FilterAnyDispensingMode: 'Било који режим',
			FilterSearchDispensingMode: 'Претражи режим',
			FilterAtcGroup: 'Терапијска група',
			FilterAnyAtcGroup: 'Било која група',
			FilterSearchAtcGroup: 'Претражи групу',
			FilterAtcClass: 'Фармаколошка класа',
			FilterAnyAtcClass: 'Било која класа',
			FilterSearchAtcClass: 'Претражи класу',
			...
			SortLabel: 'Сортирање',
			SortPopular: 'Прво популарни',
			SortNameAsc: 'По азбуци',
