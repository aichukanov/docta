...
export default {
	messages: {
		'en': {
			...
			tabDoctor: 'Doctor Profile',
			tabClinics: 'My Clinics',
		...
		'ru': {
			...
			tabDoctor: 'Профиль врача',
			tabClinics: 'Мои клиники',
			comingSoon: 'Скоро',
			comingSoonDesc: 'Этот раздел находится в разработке',
			user: 'Пользователь',
			cancel: 'Отмена',
			save: 'Сохранить',
		...
		'de': {
			...
			tabDoctor: 'Arztprofil',
			tabClinics: 'Meine Kliniken',
			comingSoon: 'Demnächst',
			comingSoonDesc: 'Dieser Abschnitt ist in Entwicklung',
			// Profil bearbeiten
			editName: 'Name',
			editEmail: 'E-Mail',
			...
			confirmUnlinkFacebook: 'Möchten Sie Ihr Facebook-Konto wirklich trennen?',
			// Erfolgsmeldungen
		...
		'tr': {
			...
			tabDoctor: 'Doktor Profili',
			tabClinics: 'Kliniklerim',
			comingSoon: 'Yakında',
			comingSoonDesc: 'Bu bölüm geliştirme aşamasındadır',
			// Profil düzenleme
			editName: 'İsim',
			editEmail: 'E-posta',
