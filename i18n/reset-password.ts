...
export default {
	messages: {
		...
		'sr': {
			...
			successDescription:
				'Vaša lozinka je uspješno promijenjena. Sada ćete biti preusmjereni na stranicu za prijavu.',
		...
		'sr-cyrl': {
			...
			passwordRequirements: 'Захтјеви за лозинку:',
			...
			successTitle: 'Лозинка промијењена',
			successDescription:
				'Ваша лозинка је успјешно промијењена. Сада ћете бити преусмјерени на страницу за пријаву.',
