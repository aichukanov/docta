export default {
	messages: {
		...
		'sr': {
			...
			errorDeleteSession: 'Neuspješno završavanje sesije',
			errorLogoutAll: 'Neuspješno završavanje sesija',
			...
			forgotPasswordSentTitle: 'Provjerite email',
			forgotPasswordSentSubtitle:
				'Poslali smo link za resetovanje lozinke na vaš email.',
			forgotPasswordError: 'Neuspješno slanje linka',
			cancel: 'Otkaži',
			save: 'Sačuvaj',
		...
		'sr-cyrl': {
			security: 'Безбједност',
			securityDescription: 'Управљање лозинком и активним сесијама',
			password: 'Лозинка',
			changePassword: 'Промијени',
			setPassword: 'Постави',
			changePasswordTitle: 'Промјена лозинке',
			...
			passwordChanged: 'Лозинка успјешно промијењена',
			sessionDeleted: 'Сесија завршена',
			allSessionsDeleted: 'Све остале сесије завршене',
			errorDeleteSession: 'Неуспјешно завршавање сесије',
			errorLogoutAll: 'Неуспјешно завршавање сесија',
			...
			forgotPasswordSentTitle: 'Провјерите email',
			forgotPasswordSentSubtitle:
				'Послали смо линк за ресетовање лозинке на ваш email.',
			forgotPasswordError: 'Неуспјешно слање линка',
			cancel: 'Откажи',
			save: 'Сачувај',
