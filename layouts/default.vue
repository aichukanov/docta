...
<i18n lang="json">
{
	...
	"sr-cyrl": {
		...
		"Email": "Email",
		"Telegram": "Telegram",
		"DisclaimerShort": "Само информативно. Није медицински савјет.",
		"ContactUs": "Контактирајте нас путем emaila",
		"NewsChannel": "Наш канал за вијести на Телеграму",
	...
	.footer-content {
		...
		.footer-bottom {
			...
			&__left {
				...
				align-items: center;
				flex-wrap: wrap;
				gap: var(--kit-spacing-sm) var(--kit-spacing-lg);
			}
