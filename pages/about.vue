...
<i18n lang="json">
{
	...
	"sr": {
		"Title": "O projektu",
		"Description": "{siteName} je projekat ekspata koji žive u Crnoj Gori. Prikupljamo informacije o ljekarima, klinikama, analizama i medicinskim uslugama da bismo olakšali pretragu zdravstvene zaštite.",
		"Subtitle": "Pomažemo ljudima da pronađu ljekare i medicinske usluge u Crnoj Gori prikupljanjem informacija iz više izvora na jednom mjestu.",
		"AboutUsTitle": "O nama",
		"AboutUsP1": "Mi smo mali tim ekspata koji žive u Crnoj Gori. Kada smo se preselili ovdje, suočili smo se sa istim izazovom sa kojim se suočavaju mnogi pridošlice: kako pronaći pravog ljekara ili kliniku u novoj zemlji, posebno bez poznavanja lokalnog jezika.",
		...
		"WhatWeDoP1": "{siteName} prikuplja i strukturira informacije o ljekarima, klinikama, laboratorijskim testovima i medicinskim uslugama iz otvorenih izvora širom Crne Gore.",
		...
		"DataSourcesLi3": "Javni cjenovnici i katalozi usluga",
		"DataSourcesLi4": "Medicinski referentni izvori za opšte opise",
		"DataSourcesNote": "Pružamo direktne kontakt informacije za svaku kliniku kako biste mogli da provjerite sve detalje.",
		...
		"ImportantLi1": "Referentne vrijednosti i indikacije mogu se razlikovati u zavisnosti od laboratorije, metodologije i kliničkog konteksta.",
		"ImportantLi2": "Sajt ne pruža medicinske usluge.",
		"ImportantLi3": "Sajt ne zamjenjuje konsultaciju sa ljekarom.",
		"ImportantLi4": "Sajt ne snosi odgovornost za postupke klinika i ljekara.",
		"ResponsibilityTitle": "Ograničenje odgovornosti",
		"ResponsibilityP1": "Informacije na sajtu mogu zastarjeti i mogu sadržati netačnosti iz izvora.",
		"ResponsibilityP2": "Prije donošenja odluka o zdravlju posavjetujte se sa ljekarom i provjerite detalje u klinici ili laboratoriji.",
	...
	"sr-cyrl": {
		"Title": "О пројекту",
		"Description": "{siteName} је пројекат експата који живе у Црној Гори. Прикупљамо информације о љекарима, клиникама, анализама и медицинским услугама да бисмо олакшали претрагу здравствене заштите.",
		"Subtitle": "Помажемо људима да пронађу љекаре и медицинске услуге у Црној Гори прикупљањем информација из више извора на једном мјесту.",
		"AboutUsTitle": "О нама",
		"AboutUsP1": "Ми смо мали тим експата који живе у Црној Гори. Када смо се преселили овдје, суочили смо се са истим изазовом са којим се суочавају многи придошлице: како пронаћи правог љекара или клинику у новој земљи, посебно без познавања локалног језика.",
		...
		"WhatWeDoP1": "{siteName} прикупља и структурира информације о љекарима, клиникама, лабораторијским тестовима и медицинским услугама из отворених извора широм Црне Горе.",
		...
		"DataSourcesLi3": "Јавни цјеновници и каталози услуга",
		"DataSourcesLi4": "Медицински референтни извори за опште описе",
		"DataSourcesNote": "Пружамо директне контакт информације за сваку клинику како бисте могли да провјерите све детаље.",
		...
		"ImportantTitle": "Важно",
		"ImportantLi1": "Референтне вриједности и индикације могу се разликовати у зависности од лабораторије, методологије и клиничког контекста.",
		"ImportantLi2": "Сајт не пружа медицинске услуге.",
		"ImportantLi3": "Сајт не замјењује консултацију са љекаром.",
		"ImportantLi4": "Сајт не сноси одговорност за поступке клиника и љекара.",
		"ResponsibilityTitle": "Ограничење одговорности",
		"ResponsibilityP1": "Информације на сајту могу застарјети и могу садржати нетачности из извора.",
		"ResponsibilityP2": "Прије доношења одлука о здрављу посавјетујте се са љекаром и провјерите детаље у клиници или лабораторији.",
