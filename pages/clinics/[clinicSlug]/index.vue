...
<i18n lang="json">
{
	"en": {
		...
		"TabReviews": "Reviews",
		"TabMap": "Location",
		"SeoTitleDoctors": "{count} specialists",
	...
	"ru": {
		...
		"TabReviews": "Отзывы",
		"TabMap": "На карте",
		"SeoTitleDoctors": "{count} специалистов",
	...
	"de": {
		...
		"TabMap": "Standort",
		"SeoTitleDoctors": "{count} Spezialisten",
	...
	"sr": {
		...
		"TabMap": "Lokacija",
		"SeoTitleDoctors": "{count} stručnjaka",
	...
	"sr-cyrl": {
		...
		"TabMap": "Локација",
		"SeoTitleDoctors": "{count} стручњака",
