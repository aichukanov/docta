...
const { specialtyIds, cityIds, languageIds, clinicIds, name } = toRefs(
	filtersStore.namespaces.doctors,
);
...
watch(
	...
	(query) => {
		...
		filtersStore.updateFromRoute('doctors', query);
	},
	{ immediate: true },
);
...
const filterQuery = computed(
	() => filtersStore.getRouteParams('doctors').query,
);
...
<template>
	...
	>
		...
		<template #tips>
			...
			<DoctorRelatedFilters :specialtyIds="specialtyIds" :cityIds="cityIds" />
		</template>
	</ListPage>
</template>
