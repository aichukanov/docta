...
**Поправка 2026-09-01: виртуализация ЕСТЬ и обязательна.** Оценка «~130
элементов» неверна: в админку уходят целые справочники — 8194 отзыва,
5237 услуг, 1591 анализ. Окно видимых строк + фиксированная высота строки.
