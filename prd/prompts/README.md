...
> **Статус на 2026-07-26: все 7 промптов отработаны, новых задач здесь нет.**
> Окна 1–5 закрыты 2026-06-12 (каталог, аналитика, кабинет+биллинг, отзывы, приватность),
> окно 6 (`07-distance-vs-price-sort`) — тогда же: выбран единый композитный скор,
> решение зафиксировано в [clinic-catalog/PROGRESS.md](../clinic-catalog/PROGRESS.md),
> раздел «Сортировки: расстояние vs цена vs рейтинг». Папка сохранена как образец
> формата промпта для будущих параллельных запусков.
