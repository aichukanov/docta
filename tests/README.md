...
│   ├── home.spec.ts
│   ├── navigation.spec.ts
│   ├── locale.spec.ts         # Система локализации ⭐ НОВОЕ
│   ├── clinics.spec.ts
│   ├── doctors.spec.ts
│   ├── services.spec.ts
│   ├── medications.spec.ts
...
### Система локализации ⭐
- ✅ Query параметры (`?lang=ru`, `?lang=en`)
- ✅ Cookie для локали
- ✅ Language Switcher компонент
- ✅ SSR и гидратация
- ✅ Редиректы для дефолтной локали
- ✅ Граничные случаи (невалидные локали, deprecated)
